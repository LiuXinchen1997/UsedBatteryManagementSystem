	    ...
	    <li class="level1">
            ...
            <ul class="MenuLevel2">
                ...
                <li class="level2 level2Style">
                	<a target="right" href="userInfoManage.jsp">用户信息管理</a>
				</li>
				 <li class="level2 level2Style">
                	<a target="right" href="deviceInfoManage.jsp">装置信息管理</a>
				</li>
				<li class="level2 level2Style">
                	<a target="right" href="deviceMap.jsp">查看装置地图</a>
				</li>
				
			
				<li class="level2 level2Style">
                	<a target="right" href="adminExit.action">退出/注销</a>
				</li>
            </ul>
        </li>
    </ul>
